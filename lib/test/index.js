...
describe('doc-path Module', () => {
    describe('evaluatePath', () => {
        ...
        it('should return undefined if the property does not exist on an object', (done) => {
            ...
            assert_1.default.equal((0, path_1.evaluatePath)(doc, 'downloads'), undefined);
            done();
        });
    });
    describe('setPath', () => {
        ...
        it('should throw an error if no key path was provided', (done) => {
            try {
                doc = {};
                const kp = null;
                assert_1.default.equal(kp, null);
                (0, path_1.setPath)(doc, kp, 'null');
                done(new Error('Should not have succeeded'));
            }
            catch (err) {
                assert_1.default.equal(err instanceof Error ? err.message : '', 'No keyPath was provided.');
                done();
            }
        });
        it('should work with multiple accesses', (done) => {
